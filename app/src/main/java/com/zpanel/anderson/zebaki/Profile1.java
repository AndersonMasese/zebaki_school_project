...
public class Profile1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String pro=intent.getStringExtra("universities");//takinng the telephone string intent
        final String JSON_URL = "http://www.zebaki.co.ke/zebakiFetchJsonRegs.php/query?field="+pro;
        //make the class pick the intent telephone sent from tab3
    ...
    */
    ...
    public void showParseActivity() {
        Intent intent = new Intent(this, ParseJSON1.class);
    ...
    private void getJSON(String url) {
        class GetJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Profile1.this, "Please Wait...",null,true,true);
            }
